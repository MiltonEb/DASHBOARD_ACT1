...
const navItems: NavItem[] = [
  {
    icon: <GridIcon />,
    name: "Dashboard",
    subItems: [{ name: "Users data", path: "/", pro: false }],
  }
];
      ...
      >
        <Link href="/">
          {isExpanded || isHovered || isMobileOpen ? (
            ...
            <>
            <h1 className="dark:hidden text-gray-dark font-extrabold">D</h1>
            <h1 className="hidden dark:block text-white font-extrabold">D</h1>
            </>
          )}
        </Link>
      </div>
