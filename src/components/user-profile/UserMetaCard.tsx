...
export default function UserMetaCard({ firstName, lastName, location, picture }: UserMetaCardProps) {
  return (
    <div 
      role="region"
      aria-label="Información de contacto del usuario"
        ...
        <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
          ...
          <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Facebook de Pimjo (se abre en nueva ventana)"
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Twitter/X de Pimjo (se abre en nueva ventana)"
              className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
            >
              <svg
                aria-hidden="true"
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="LinkedIn de Pimjo (se abre en nueva ventana)"
              className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
            >
              <svg
                aria-hidden="true"
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Instagram de Pimjo (se abre en nueva ventana)"
              className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
            >
              <svg
                aria-hidden="true"
